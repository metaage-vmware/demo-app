...
{
  "bsGitBranch" : "master",
  "bsGitRepository" : "github.com?owner=metaage-vmware&repo=demo-app",
  "projectName" : "demo-app",
  "repositoryPrefix" : "tap-harbor.vm-metaage.lab/tap-tkgm/apps/"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->demo-app]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->tap-harbor.vm-metaag...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=metaage-vmware&repo=demo-app'
